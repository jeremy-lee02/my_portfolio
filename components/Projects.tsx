        ...
        <div className='relative w-full flex overflow-x-scroll snap-x snap-mandatory z-20 scrollbar-thin hover:scrollbar-thumb-[#00000065] scrollbar-thumb-[#0000ffb6] scrollbar-track-[#ffffffa4] scrollbar-thumb scrollbar-corner-white scrollbar-track'>
            {projects?.map((project , i) => (
                    ...
                    <div className='grid grid-row-2 mt-10'>
                        ...
                        <div key={project._id} className='w-screen snap-center grid grid-cols-2 space-y-5 items-center justify-center px-16 h-full'>
                            <img src= {urlFor(project.skillImage).url()} width={300} height={370} alt=""  className='max-w-full' />
                            <div className='grid px-0 md:px-8 max-w-full h-1/2 overflow-y-auto'>
                                <p className='text-[18px]'>{project.description}</p>
                            </div>
                        </div>
                    </div>
